...
public interface GameContract {
    ...
    interface View {
        ...
        void showFinalGameAlertDialog(); // показ финального диалогового окна, если проходим все уровни игры
        void showHelpByPushkinAlertDialog(int level); // показ диалогового окна, если просим помощи у Пушкина
